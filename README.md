...
- 2026-08-21已锁定减负后的来源、过程文件、七Sheet最终工作簿和独立QA合同；这次规则同步不构成P1。
...
2. `<Run_ID>-最终关键词词库.xlsx`：固定七个可见Sheet——最终关键词决策总表、SKU事实卡、品类产品通用词库、关键词竞争性分析、关键词趋势性分析、词频统计、否词库。通用词库、词频、竞争和趋势只使用第二板块已判定`通用词库资格=纳入`的适用人口；二类词保留在过程工作簿Sheet4并全量进入最终总表。
