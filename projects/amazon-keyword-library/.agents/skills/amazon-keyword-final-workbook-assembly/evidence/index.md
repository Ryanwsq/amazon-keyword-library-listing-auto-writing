...
- Skill: `amazon-keyword-final-workbook-assembly`
- Maturity: `draft`
...
| `case-03-edge-or-error.md` | edge-or-error | accepted | `4a903057765e136c85c5dc4704178c076f3ce467` | `gaming-chair-assembly-user-stop-01` | user-confirmed candidate and safe stop 2026-08-27 |
...
已接纳一个人工确认业务候选但跳过独立QA与seal的边界案例；两个正常案例仍为`planned`。Skill保持`draft`，P1未完成。
