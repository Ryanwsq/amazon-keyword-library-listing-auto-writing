...
|---|---|---|---|---|---|
| `keyword-quality-process` | `../../../../docs/end-to-end-workflow.md` | 项目主任务维护 | run_type、ASIN代表人口、来源登录门、单次导出、全阶段、compact-validation/full-regression、21项门和当前状态 | 2026-09-02 | 建立测试验证检查顺序 |
| `keyword-quality-boundaries` | `../../../../docs/keyword-judgment-boundaries.md` | 用户确认决策 | test-validation专用边界、来源入口/登录门、核心层级、完整风险人口、数据允许缺口、qa_mode和停止条件 | 2026-09-02 | 判定pass、blocked或incomplete |
