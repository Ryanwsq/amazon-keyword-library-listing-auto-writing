...
After input and marketplace are locked, open the matching Amazon site in this task and wait for the user to log in manually. Do not ask any question until this session returns `authenticated`. If the page enters another Amazon marketplace, stop, record `marketplace_mismatch`, and request user intervention.
