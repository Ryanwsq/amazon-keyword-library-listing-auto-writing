...
1. 核对明确下发的角色 `product-audit`、版本 `listing-release-candidate-20260914-rc12` 和 [package-manifest.json](package-manifest.json) 哈希。
2. 完整读取 [Agent.md](Agent.md) 和 [任务包交接边界](contracts/dispatch-and-loading.md)。
3. 完整读取所属 [audit-alexa-shopping-product-info](.agents/skills/audit-alexa-shopping-product-info/SKILL.md)。
