...
2026-09-14来源入口更新：SIF竞品反查及卖家精灵扩词均MCP优先；仅MCP明确报错后提示用户登录对应官网并验证，才用官网备用。零/缺字段/不完整不是报错，MCP正常无需网页登录。其他来源/趋势不变；完整读取[任务会话登录合同](references/login-session-contract.md)。
