...
1. 核对明确下发的角色 `listing-writing-qa`、版本 `listing-release-candidate-20260914-rc12` 和 [package-manifest.json](package-manifest.json) 哈希。
2. 完整读取 [Agent.md](Agent.md) 和 [任务包交接边界](contracts/dispatch-and-loading.md)。
3. 完整读取所属 [apply-amazon-listing-hard-rules](.agents/skills/apply-amazon-listing-hard-rules/SKILL.md)。
