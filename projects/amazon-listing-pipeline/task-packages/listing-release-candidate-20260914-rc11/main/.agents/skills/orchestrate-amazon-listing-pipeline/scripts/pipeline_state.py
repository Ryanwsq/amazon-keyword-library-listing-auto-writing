        ...
        requirements.append(
            {
                ...
                **({"source_policy": SIF_SOURCE_POLICY, "entry_priority": ["mcp", "web"]} if provider == "sif" else {}),
                "status": "pending",
                "task_id": None,
                "host": None,
                "dispatch_id": None,
...
def cmd_init(args: argparse.Namespace) -> int:
    ...
    manifest: dict[str, Any] = {
        ...
        "source_policies": {"sif_competitor": SIF_SOURCE_POLICY},
...
def cmd_confirm_login_session(args: argparse.Namespace) -> int:
    ...
    if session.get("source_policy") == SIF_SOURCE_POLICY:
