...
| `product-keyword-library.md` | verified | V2.1 + V2.2 + Post-V2.1 contracts through 2026-09-03, including single export, login escalation, ASIN representatives, test-only QA, lossless runtime, and 30-day same-category/conditional-subdivision final-library reuse with new facts | 2026-09-03 | sanitized | 稳定领域对象、概念关系和已确认方法结论 |
...
| `keyword-decision-log.md` | verified | complete V0.1–V2.1 chain, V2.2 component, Post-V2.1 runtime optimization, recent final-library reuse and 2026-09-03 project consistency maintenance without business-rule changes | 2026-09-03 | sanitized | 完整版本沿革、当前基线、增量决策和替代关系；治理检查不生成P1 |
