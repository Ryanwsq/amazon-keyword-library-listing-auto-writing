...
|---|---|---|---:|---|---|
| `product-keyword-library.md` | verified | V2.1 + V2.2 + Post-V2.1 contracts through 2026-09-02, including single SellerSprite export per seed, main-task login escalation, >5 ASIN product-type representatives, and test-only independent QA | 2026-09-02 | sanitized | 稳定领域对象、概念关系和已确认方法结论 |
...
| `keyword-decision-log.md` | verified | complete V0.1–V2.1 chain, V2.2 component, and Post-V2.1 decisions through 2026-09-02 single-export/login/ASIN-representative/test-only-QA routing | 2026-09-02 | sanitized | 完整版本沿革、当前基线、增量决策和替代关系 |
